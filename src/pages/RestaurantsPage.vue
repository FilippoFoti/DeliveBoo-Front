...
<template>
  <div
    class="container"
    :class="{ 'popup-open': selectedRestaurant || showRestaurantDetails }"
  >
    ...
    <div class="row row-cols-4">
      ...
      >
        <div class="card">
          ...
          <button @click="showMenu(restaurant.id)" class="btn btn-primary mb-2">
            Mostra menu
          </button>
          <button @click="showDetails(restaurant)" class="btn btn-primary">
            Dettagli
          </button>
        </div>
      </div>
    ...
    <div v-if="selectedRestaurant">
      <div class="popup">
        <div class="popup-content p-5">
          ...
          <ul class="px-0">
            <li
              v-for="dishe in selectedRestaurant.dishes"
              :key="dishe.id"
              class="list-unstyled"
            >
              <div class="dishe-item">
                ...
                <div class="dishe-details">
                  ...
                  <button @click="addToCart(dishe)" class="btn btn-primary">
